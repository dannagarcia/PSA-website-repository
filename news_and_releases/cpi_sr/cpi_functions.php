<?php
	...
	function error() {
		echo '<div class="padding10 align-center">
				<h3 class="text-light">Table Not Available...</h3>
			</div>';
	}

	function generateTable1($tablename,$month, $year1, $year2) {			
		$table1 = fopen($tablename, "r") or die(error());											
		$line;
    ...
    function generateTable2($tablename) {
		$table2 = fopen($tablename, "r") or die(error());
		$line;
    ...
    function generateTable3($tablename, $month_a, $month_b) {
    	$table3 = fopen($tablename, "r") or die(error());
    	$line;
    ...
    function generateTable4($tablename, $month_a, $month_b) {
    	$table4 = fopen($tablename, "r") or die(error());
    ...
    function generateTable5($tableName, $year1, $year2, $month_a, $month_b) {
    	$table5 = fopen($tableName, "r") or die(error());
    	$line;
