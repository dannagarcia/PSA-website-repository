			...
			<div class="row cells12 align-justify">
				<div class="cell colspan9 padding10">
					...
					<ul class="breadcrumbs">
					    ...
					    <li>2015</li>
					    <li><a href="/rucar/news_and_releases/sat_acc/sa_index.html">April 2015 Price Situation in the Cordillera</a></li>
					</ul>
					<hr class="thin bg-grayLighter">
					
					<div class="row cells12 align-left">
					<p class="align-center"><strong>April 2015 Price Situation in the Cordillera</strong></p><br><br><br>
							<div class="tabcontrol" data-role="tabControl">
	                            ...
	                            <div class="frame bg-white" id="tab1" style="display: block;">
	                                ...
	                                <ul>
	                                	<li>The  Consumer Price Index of CAR in April, 2015 was 138.5, higher by 3.3 from last year’s 135.2.</li>
	                                	<li>Generally, there was an increase in the CPI of all the provinces due to the increase in the average prices of goods and services..</li>
											<div class="padding20"><p class="align-center"><strong>Table 1. Consumer Price Index by Province, CAR:  April 2014 and April 2015 (2006=100)</strong></p>
	                                		<?php
			                                	generateTable1("table1april2015.csv", "April", "2014", "2015");
	                                		?>
	                                		</div>


	                                	<li>Among provinces, Mt. Province posted the highest CPI at 143.3 followed by Benguet at 141.5 and Ifugao at 141.1. On the other hand, Apayao posted the lowest at 130.0. </li>
	                                	<li>In terms of index point change, Benguet reported the highest at 5.4 while Ifugao was lowest at 0.2.</li>
	                                	...
	                                	<div class="padding20">
											<p class="align-center"><strong>Table 2. Consumer Price Index by Commodity Group and by Province, CAR: April, 2015 (2006=100)</strong></p>

											<?php
												generateTable2("table2april2015.csv");
											?>
										</div>
                                </div>
                                ...
                                <div class="frame bg-white" id="tab2" style="display: none;">
									...
									<ul>
										...
										the highest consumer price index at 194.8 followed by Kalinga and Benguet at 191.0
										and 190.4, respectively.</li>

										<li>Food and Non-Alcoholic Beverages came next with Benguet having the most at
										157.2 followed by Mt. Province at 153.7.
										</li>
										...
										Beverages at 4.7 and 4.6, respectively.
										</li>
									...
									<p class="align-center"><img src="/rucar/images/cpi/2015/april/Year-on-Year Consumer Price Index by Commodity Group.png"></p>

									<p><strong>Inflation Rate</strong></p>	
									<ul>
										<li>The Inflation Rate of Car in April, 2015 was 2.4%, lower by 0.5 percentage points from the last year's Inflation Rate.</li>
										<li>Benguet posted  the  highest  rate  of 4.7 percent, followed by  Mt.  Provinceat 2.7 percent. On the other hand, Ifugaoposted the lowest Inflation Rate at  0. 1 percent.</li>
										<li>April , 2015 Inflation Rate in all provinces is lower compared to last year except  for Benguet that  increased in its inflation  rate . It  showed  that  the  rate  of  change  in  the  average prices in  Benguet is fast compared with the provinces that  decreased in their inflation rates.</li>
										<li></li>
									</ul>
									<p class="align-center"><img src="/rucar/images/cpi/2015/april/Year-on-Year inflation Rates by province.png"></p>
                                ...
                                <div class="frame bg-white" id="tab3" style="display: none;">
									...
									<ul>
										<li>The annual inflation  for  All Items in the Cordillera was 2.4 . Among the regions , CAR had the higher annual gains.</li>		

										<li>By  commodity,  the  year-on-year  growth  of  the  heavily-weighted  Food  and  Non - Alcoholic  Beverages index  in the  Cordillera  was 3.2 percent. Housing,  Water,  Electricity,  Gas  and  Other  Fuels ; Health and Restaurants  and  Miscellaneous  Good  and  Services decreased  in  their  inflation  rates.    Furnishing,  Household  Equipment  and Routine Maintenance of the House and Health increased in their inflation rates. Alcoholic  Beverages  and  Tobacco; Clothing  and  Footwear; Recreation  and  Culture ; Communication  and Education  indices  remained  compared  to  the  pr e vi ou s  years ’  indices. Transport had a negative index although it increased in its inflation rate .</li>
									</ul>
									<div class="padding20">
										...
										<?php
											generateTable3("table3april2015.csv", "April", "March");
                                ...
                                <div class="frame bg-white" id="tab4" style="display: none;">
									...
									<ul>
										<li>In  the  region,  the  inflation  rate for All  Items was at 0.1 percent  during  the  month, same IR compared to the previous month.  The Food and Non-Alcoholic Beverages index increased  at 0.2 percent.There  was  no  change  in  the  inflation  rates  for  the Communication and Educationcommodity groups.</li>
									</ul>
									<div class="padding20">
										<p class="padding20"><strong>Table 4. Month-on-Month Inflation Rates by Commodity Groups, CAR: April 2015 and April 2015 (2006 = 100)</strong></p>
										<?php
										
											generateTable4("table4april2015.csv", "April", "March");
                                ...
                                <div class="frame bg-white" id="tab5" style="display: none;">
									...
									<ul>
										<li>Generally,  for  the  year-on-year  inflation  rates  of  selected  food  items  for  the  region, there was decrease for some food items.There was an annual increase in the other food items.Fruits index resulted in a two-digit value but had a decrease of 0.8 in its inflation rate from 14.4 to 13.6%.</li>
										<li>Fish remained in its inflation rate.  </li>
									</ul>
									<div class="padding20">
										<p class="align-center"><strong>Table 5. Year-on-Year Inflation Rates of Selected Food Items, CAR: March and April 2015 and 2014 (2006 = 100)</strong></p>
										<?php

											generateTable5("table5april2015.csv", "2015", "2014", "April", "March");
										?>
									</div>
									<p><strong>Purchasing Power of the Peso (PPP)</strong></p>
									<ul>
										<li>The value of the peso in CAR dropped to 72 centavos from last year’s  74 centavos.  Meaning, that  market  value of  goods  and  services  worth 72 centavos in  April , 2006  were bought at one peso in April , 2015 .</li>
										<li>Compared  to April,2014,  the Purchasing  Power  of  the  Peso of  four provinces decreased. Abra and Ifugao remained in their PPP.</li>
										<li>Abra  and Apayao had  the  highest  peso  value,  both at 77centavos followed  by Kalinga at 75 centavos. On the other hand,Mt. Province had the lowest peso valueat 70 centavos.</li>
									</ul>
									<p class="align-center"><img src="/rucar/images/cpi/2015/april/Purchasing Power of the Peso.png"></p>
                                </div>
                        ...
                        <div class="tile-container align-left">
							<a href="/rucar/pdf/cpi_sr/CPISR_APRIL%202015.pdf">
						        <div class="bg-darkTeal tile tile-small" data-role="tile">
						            <div class="tile-content iconic">
									    ...
									    data-hint-mode="4"
									    data-hint="Download PDF|April 2015 Price Situation in the Cordillera"
										></span>
									</div>
						        </div>
					         </a> 
